const { unwrapHMAC } = require('./lib/protobuf/hmac-wrapper');
const { protobufDecoder } = require('./lib/protobuf/decoder');

// Payload recibido en hex
const hexPayload = '1082a9cfc5061801 2a1c446576696365 20636f6e66696720 7570646174656420 2849443d3529'.replace(/\s/g, '');
